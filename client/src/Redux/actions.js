...
const BACKEND_URL= "https://backen-pokemons-production.up.railway.app"

export const getPokemons =()=>{
  return async function (dispatch) {
    const apiData= await axios.get(`${BACKEND_URL}/pokemons`)
...
export const getPokemon =(id)=>{
  return async function (dispatch) {
    const apiData= await axios.get(`${BACKEND_URL}/pokemons/${id}`)
...
export const getPokemonByName =(name)=>{
  return async function (dispatch) {
    const apiData= await axios.get(`${BACKEND_URL}/pokemons/byname?name=${name}`)
    const pokemon= apiData.data
...
export const getTypes= ()=>{
  return async function (dispatch) {
    const apiData= await axios.get(`${BACKEND_URL}/pokemons/types`)
